...
public interface Router {
    ...
    default MetadataDiscoveryBrokerEndpointBinding metadataDiscoveryBrokerEndpointBinding(BootstrapEndpointBinding bootstrapEndpointBinding, int nodeId) {
        return new MetadataDiscoveryBrokerEndpointBinding() {
            ...
            public Integer virtualNodeId() {
                return bootstrapEndpointBinding.virtualNodeId();
            }
        };
    }
    /**
